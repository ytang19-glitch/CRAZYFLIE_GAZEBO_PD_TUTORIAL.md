...
Confirm that the correct image was downloaded:

```bash
docker images yujietang/crazyflie-gazebo-pd:v3
```

Expected image information:

```text
Repository: yujietang/crazyflie-gazebo-pd
Tag:        v3
Image ID:   f28c6ea5c7f7
```
